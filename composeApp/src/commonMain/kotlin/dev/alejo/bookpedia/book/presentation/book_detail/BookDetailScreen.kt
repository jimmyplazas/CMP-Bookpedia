...
import cmp_bookpedia.composeapp.generated.resources.description_no_available
...
import dev.alejo.bookpedia.book.presentation.book_detail.components.BlurredImageBackground
import dev.alejo.bookpedia.book.presentation.book_detail.components.BookChip
import dev.alejo.bookpedia.book.presentation.book_detail.components.ChipSize
...
private fun BookDetailScreen(
    ...
    BlurredImageBackground(
        ...
        onFavouriteClick = { onAction(BookDetailAction.OnFavouriteClick) },
                ...
                if (state.isLoading) {
                    ...
                    Text(
                        text = if(state.book.description.isNullOrBlank()) {
                            stringResource(Res.string.description_no_available)
                        } else {
